...
summary: Review implementation quality, debt introduced, and residual risk before release.
---
...
- Is the implementation approach the simplest valid solution?
- Use `minimalist_review_change` to score minimalism
- Use `minimalist_simplification_notes` to identify duplication
- Check for unnecessary abstractions, premature optimization, or over-engineering

### 3. Review Debt Introduced
- New dependencies added?
- New complexity introduced (cyclomatic, cognitive)?
